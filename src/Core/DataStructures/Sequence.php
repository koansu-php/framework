...
class Sequence implements Countable, IteratorAggregate, ArrayAccess
{
    /**
     * @var array
     **/
     ...
     * @return self
     **/
    public function extend(iterable $values)
    {
     ...
     * Sort the list.
     *
     * @param callable|null $sorter (optional)
     *
     * @return self
     **/
     ...
     * @return array
     **/
    public function apply(callable $callable) : array
    {
     ...
     * @return array
     **/
    protected function castToArray($source) : array
    {
        if (is_array($source)) {
