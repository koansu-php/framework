...
namespace Koansu\DependencyInjection\Contracts;
 ...
 * Interface Container
 *
 * The koansu container tries to fulfill the following main principles:
 ...
 *
 */
interface Container extends ContainerInterface, Subscribable, Hookable
{
    /**
     ...
     * If you don't like to pass the $abstract to a callable use self::provide().
     *
     ...
     * type-hinted params, resolve them and inject them.
     *
