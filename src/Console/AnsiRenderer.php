<?php
/**
 *  * Created by mtils on 03.12.2022 at 14:17.
 **/
 ...
 * render this view.
 */
class AnsiRenderer implements Extendable
{
    use ExtendableTrait;
    ...
    public function __invoke(RenderData $renderData)
    {
        try {
            $template = $renderData->template;
            return $this->callExtension($template, $this->getExtension($template), [$template, $renderData->assignments, $this]);
        } catch (HandlerNotFoundException $e) {
            throw new OutOfBoundsException('No handler for template "$item->template" found.', 0, $e);
        }
    }
     ...
     * @return string
     */
    public function table(iterable $rows, array $header=[]) : string
    {
