<?php
/**
 *  * Created by mtils on 28.10.2022 at 17:54.
 **/
...
class RouteRegistry implements RouteRegistryContract
{
    ...
    public function compile(RouterContract $router) : array
    {
        ...
        foreach ($this->clientTypes() as $clientType) {
            ...
            $compiled[self::KEY_DISPATCHER_DATA][$clientType] = $dispatcher->__toArray();
        }
     ...
     */
    protected function newCollector(array $attributes=[]) : RouteCollector
    {
