<?php
/**
 *  * Created by mtils on 18.12.2022 at 10:01.
 **/
...
{
    public function __invoke(string $view, array $vars, AnsiRenderer $renderer) : string
    {
        ...
        if (!Type::is($routes, Traversable::class)) {
            throw new TypeError("Routes have to be traversable");
        }
