<?php
/**
 *  * Created by mtils on 23.10.2022 at 19:57.
 **/
 ...
 * In psr-7 requests are immutable. The http part of koansu is built compatible to
 * this.
 */
interface Input extends ArrayAccess, IteratorAggregate, Countable
{
     ...
     * allow routes in one scope vs another. Return a string or object with
     * __toString() method returning the pattern of this scope.
     *
