<?php
/**
 *  * Created by mtils on 30.10.2022 at 17:44.
 **/
...
class UrlGenerator implements UrlGeneratorContract
{
    ...
    /**
     * @param string|RouteScope|object|null $scope
     * @return Url
     ...
     */
    protected function extractId(object $entity)
    {
        if (isset($entity->id)) {
            return $entity->id;
        }
    ...
    protected function defaultBaseUrlProvider() : Closure
    {
        return function (Input $input, $scope=null) {
            if ($url = $input->getUrl()) {
                return new Url($url->scheme . '://' . $url->host);
            }
