<?php
/**
 *  * Created by mtils on 29.01.2023 at 21:10.
 **/

namespace Koansu\Validation\Contracts;

use Koansu\Validation\Exceptions\MergingFailedException;
use Koansu\Validation\Exceptions\ValidationException;

/**
 * The koansu validation system works like the laravel validation with rules.
