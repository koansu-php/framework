<?php
/**
 *  * Created by mtils on 29.01.2023 at 21:26.
 **/
...
class Validator implements ValidatorContract, HasMethodHooks
{
    use HookableTrait;
    ...
    public function __construct(array $rules=[], string $ormClass='', callable $baseValidator=null)
    {
        ...
        $this->baseValidator = $baseValidator ?: new MatcherBaseValidator(new Matcher());
    }
     ...
     * @return array
     **/
    protected function validateByBaseValidator(Validation $validation, array $input, array $baseRules, object $ormObject=null, array $formats=[]) : array
    {
     ...
     */
    protected function prepareRulesForValidation(array $rules, array $input, object $ormObject=null, array $formats=[]) : array
    {
     ...
     * @return array
     */
    protected function performValidation(array $input, Validation $validation, object $ormObject=null, array $formats=[]) : array
    {
     ...
     *
     */
    protected function validateByOwnMethods(Validation $validation, array $input, array $ownRules, object $ormObject=null, array $formats=[])
    {
    ...
    protected function getBaseValidator() : callable
    {
        if (!$this->baseValidator) {
            $this->baseValidator = new MatcherBaseValidator(new Matcher());
        }
     ...
     */
    protected function cast($value, $rule, object $ormObject=null, array $formats=[])
    {
        return $value;
    }
    ...
    {
        $method = $this->getMethodByExposedName($ruleName);
     ...
     * @return bool
     */
    protected function isFromStorage(object $ormObject=null) : bool
    {
        ...
        if (method_exists($ormObject, 'isNew')) {
