<?php
/**
 *  * Created by mtils on 08.10.2022 at 09:09.
 **/

namespace Koansu\Config\Readers;
...
class IniFileReader implements IteratorAggregate
{
    ...
    /**
     * Should nest sections by supported? If yes you can give keys dots, and they
     ...
     * @return array
     */
    protected function expandNestedSections(array $iniData) : array
    {
        $separator = '.';
