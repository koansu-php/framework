<?php
/**
 *  * Created by mtils on 08.10.2022 at 07:20.
 **/

namespace Koansu\Config\Processors;
...
class ConfigVariablesParser
{
    ...
    /**
     * Assign some variables under $prefix. They can be accessed by {$prefix.key}
     *
     * @param string $prefix
     * @param array $variables
     */
    public function assign(string $prefix, array $variables) : void
    {
    ...
    /**
     * Parse all strings in a multidimensional array.
     *
     * @param RecursiveArrayIterator $iterator
     * @param array $copy
     */
    protected function parseNested(RecursiveArrayIterator $iterator, array &$copy) : void
    {
