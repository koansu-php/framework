<?php
/**
 *  * Created by mtils on 08.10.2022 at 07:54.
 **/
...
use ArrayAccess;
use ArrayIterator;
use Koansu\Config\Exception\EnvFileException;
...
class Env implements ArrayAccess, IteratorAggregate
{
    ...
    /**
     * Set environment variables by these setters.
     *
     * @var string[]
     */
     ...
     * @noinspection PhpMissingParamTypeInspection
     */
    public function load($file, callable $setter=null) : array
    {
        if (is_array($file)) {
    ...
    {
        // We use the same order as in self::get()
        $base = getenv();
     ...
     * @noinspection PhpMissingReturnTypeInspection
     */
    public static function get(string $name, bool $onlyReal=false)
    {
        if ($onlyReal) {
     ...
     * @return callable
     */
    public static function getSetter(string $name) : callable
    {
        static::buildDefaultSettersOnce();
     ...
     */
    public static function setSetter(string $name, callable $setter) : void
    {
     ...
     * @return string[]
     */
    public static function getSetterSequence() : array
    {
     ...
     */
    public static function setSetterSequence(array $sequence) : void
    {
     ...
     * @return array
     */
    protected function parseLines(array $lines, callable $setter=null) : array
    {
     ...
     * @return string[]
     */
    protected function parseAssignment($line) : array
    {
     ...
     * @return array
     */
    protected function varAndValue(string $assignment) : array
    {
     ...
     * @noinspection PhpMissingParamTypeInspection
     */
    protected function parseQuotedValue($value) : string
    {
