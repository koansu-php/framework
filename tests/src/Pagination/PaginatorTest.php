...
class PaginatorTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf(Paginator::class, $this->paginate());
    }

    /**
     * @test
     */
    public function construct_and_setPagination()
    {
     ...
     * @test
     */
    public function get_and_set_baseUrl()
    {
        $paginator = $this->paginate();
     ...
     * @test
     */
    public function setResult_without_totalCount()
    {
        $paginator = $this->paginate();
     ...
     * @test
     */
    public function pages_with_totalCount()
    {
     ...
     * @test
     */
    public function pages_with_callable_totalCount()
    {
     ...
     * @test
     */
    public function pages_with_totalCount_and_perPage_for_two_pages()
    {
     ...
     * @test
     */
    public function pages_with_addToQuery()
    {
     ...
     * @test
     */
    public function pages_with_addToQuery_without_total()
    {
     ...
     * @test
     */
    public function pages_with_totalCount_and_perPage_for_twelve_pages_and_6_per_page()
    {
     ...
     * @test
     */
    public function pages_with_totalCount_and_perPage_for_one_pages()
    {
     ...
     * @test
     */
    public function totalCount_is_not_triggered_when_not_needed()
    {
        $perPage = 10;
     ...
     * @test
     */
    public function asking_for_urls_when_none_assigned_throws_exception()
    {
     ...
     * @test
     */
    public function not_asking_for_urls_when_none_assigned_throws_no_exception()
    {
     ...
     * @test
     */
    public function pages_without_totalCount()
    {
        $result = range('a', 'z');
        $paginator = $this->paginate(1, 10);
     ...
     * @test
     */
    public function pages_without_totalCount_with_hasMore()
    {
        $result = range('a', 'z');
        $paginator = $this->paginate(1);
     ...
     * @test
     */
    public function pages_with_empty_result_and_totalCount()
    {
     ...
     * @test
     */
    public function pages_with_empty_result_and_no_totalCount()
    {
     ...
     * @test
     */
    public function pages_squeezed_to_start()
    {
     ...
     * @test
     */
    public function pages_squeezed_to_end()
    {
     ...
     * @test
     */
    public function pages_squeezed_to_center()
    {
    ...
    protected function paginate($currentPage=1, int $perPage=null) : Paginator
    {
        return new Paginator($currentPage, $perPage);
    }
}