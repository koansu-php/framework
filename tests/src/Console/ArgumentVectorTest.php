<?php
/**
 *  * Created by mtils on 26.10.2022 at 07:39.
 **/

namespace Koansu\Tests\Console;
...
//        $subject->defineShortOption('f', true);
     ...
     * @test
     */
    public function defineShortOption_throw_exception_if_option_has_more_than_one_char()
    {
        $input = ['a', 'b', 'c', '-fbar', '-f', 'baz', '--baz', '-f', 'zof'];
     ...
     */
    protected function make(array $commandLine=[], bool $removeCommand=true) : ArgumentVector
    {
     ...
     */
    protected function c($args) : array
    {
