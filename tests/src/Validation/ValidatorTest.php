...
/**
 *  * Created by mtils on 05.02.2023 at 10:11.
 **/
...
use DateTime;
use Exception;
use Koansu\Tests\Fakes\GenericEntity;
...
class ValidatorTest extends TestCase
{
    ...
    public function test_validate_forwards_to_passed_callable()
    {
        ...
        $handler = new LoggingCallable(function (Validation $validation, array $input, array $rules, $resource, $locale) {
            return $input;
        });
        ...
        $formats = [ValidatorContract::LOCALE, 'cz'];
    ...
    public function test_validate_throws_validation_exception_validation_has_count()
    {
        ...
        try {
            ...
            $validator->validate($input, $resource, [ValidatorContract::LOCALE => $locale]);
        ...
        $this->assertEquals($parsed, $handler->arg(2));
        $this->assertSame($resource, $handler->arg(3));
        $this->assertEquals([ValidatorContract::LOCALE => $locale], $handler->arg(4));
    }
    ...
    public function test_merge_merges_rules()
    {
        ...
        $parameters = [ValidatorContract::LOCALE => 'cz'];
...
//            'weight'    => 90.75,
     ...
     * @return void
     */
    protected function assertPasses(array $input, array $rules, $ormObject=null, array $formats=[]) : void
    {
        try {
