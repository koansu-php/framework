<?php
/**
 *  * Created by mtils on 28.10.2022 at 18:08.
 **/
...
use Koansu\Routing\Contracts\RouteRegistry as RegistryContract;
...
class RouteRegistryTest extends TestCase
{
    ...
    public function compiled_registry_loads_all_routes()
    {
        ...
        foreach ($baseArray as $i=>$route) {
            $this->assertEquals($route->__toArray(), $optimizedArray[$i]->__toArray());
        }
    ...
    public function compiled_registry_returns_by_entity_action()
    {
        ...
        $this->assertEquals($base->getByEntityAction('User', 'register')->__toArray(), $optimized->getByEntityAction('User', 'register')->__toArray());
