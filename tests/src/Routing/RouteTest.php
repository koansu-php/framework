<?php
/**
 *  * Created by mtils on 24.10.2022 at 19:06.
 **/
...
class RouteTest extends TestCase
{
    ...
    public function entity_sets_entity_and_action()
    {
        ...
        $route->entity(NamedObject::class, 'destroy');
        $this->assertSame(NamedObject::class, $route->entity);
     ...
     */
    protected function newRoute($method=[], string $pattern='', $handler=null) : Route
    {
