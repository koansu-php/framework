<?php
/**
 *  * Created by mtils on 15.01.2023 at 11:33.
 **/

namespace Koansu\Tests\Text\Streams\Helpers;
...
class CSVDetectorTest extends TestCase
{
    use TestData;
     ...
     * @test
     */
    public function separator_returns_right_separator_with_simple_format()
    {
     ...
     * @test
     */
    public function separator_returns_right_separator_when_separator_inside_column()
    {
     ...
     * @test
     */
    public function separator_returns_empty_string_if_no_columns_found()
    {
        $csv = "a\nb\nc\nd\ne\nf\ng\nh\ni";
     ...
     * @test
     */
    public function getSeparators_returns_separators()
    {
        $detector = $this->newDetector();
     ...
     * @test
     */
    public function addSeparator_adds_separator()
    {
        $detector = $this->newDetector();
     ...
     * @test
     */
    public function header_returns_header_of_simple_file()
    {
        $detector = $this->newDetector();
        $csv = $this->csvContent('simple-pipe-placeholder.csv');
     ...
     * @test
     */
    public function header_returns_empty_header_of_simple_file()
    {
        $detector = $this->newDetector();
        $csv = $this->csvContent('simple-pipe-placeholder.csv');
     ...
     * @test
     */
    public function header_returns_header_umlaut_columns()
    {
        $detector = $this->newDetector();
     ...
     * @test
     */
    public function header_returns_empty_header_with_numeric_columns()
    {
        $detector = $this->newDetector();
     ...
     * @test
     */
    public function header_returns_empty_header_if_columns_not_unique()
    {
        $detector = $this->newDetector();
     ...
     * @test
     */
    public function header_returns_empty_header_if_empty_column_found()
    {
        $detector = $this->newDetector();
     ...
     * @test
     */
    public function header_returns_correct_header_if_empty_column_found_at_end()
    {
        $detector = $this->newDetector();
     ...
     * @test
     */
    public function header_returns_empty_header_if_columns_without_letters_found()
    {
        $detector = $this->newDetector();
     ...
     * @test
     */
    public function header_throws_exception_if_following_line_count_doesnt_match()
    {
        $detector = $this->newDetector();
        $csv = $this->csvContent('simple-pipe-placeholder.csv');
        // Original file has 5 cols
     ...
     * @test
     */
    public function header_throws_exception_if_header_is_forced_and_file_contains_invalid_columns()
    {
        /** @var CSVDetector $detector */
        $detector = $this->newDetector()->setOption(CSVDetector::FORCE_HEADER_LINE, true);
        $csv = $this->csvContent('simple-pipe-placeholder.csv');
     ...
     * @test
     */
    public function header_returns_header_of_file_with_bom()
    {
        $detector = $this->newDetector();
    ...
    {
        $csvContent = $this->csvContents[$file] ?? static::dataFileContent($file);
        return str_replace(' | ', $separator, $csvContent);
    }

    protected function newDetector() : CSVDetector
    {
