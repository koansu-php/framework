<?php
/**
 *  * Created by mtils on 15.01.2023 at 09:36.
 **/
...
abstract class AbstractStringConverterTest extends TestCase
{
    /**
     * @var string
     **/
     ...
     * @test
     */
    public function it_can_convert_all_listed_encodings()
    {
     ...
     * @test
     */
    public function convert_leads_to_expected_conversion()
    {
        $converter = $this->newConverter();
        ...
        foreach ($converter->encodings() as $encoding) {
            ...
            $testString = $this->minimumEncodings[$encoding] ?? 'Just some ascii text';
     ...
     */
    abstract protected function newConverter() : StringConverter;
