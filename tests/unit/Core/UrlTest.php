...
class UrlTest extends TestCase
{
    ...
    public function user_and_password_are_decoded()
    {
        ...
        $this->assertEquals($result, $url->__toString());
    ...
    public function parses_and_renders_all_properties()
    {
        ...
        $this->assertInstanceOf(StringList::class, $url->path);
    ...
    protected function equals($url, $other, $parts=['scheme', 'user', 'password', 'host', 'path']) : bool
    {
