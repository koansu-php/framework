<?php
/**
 *  * Created by mtils on 08.10.2022 at 08:14.
 **/

namespace Koansu\Tests\Config;
...
class EnvTest extends TestCase
{
    ...
    public function unquoted_values_with_spaces_throw_exception()
    {
        ...
        try {
            ...
            $this->assertExceptionSays('in line', $e);
            $this->assertExceptionSays('surrounded by spaces', $e);
        }
    }
