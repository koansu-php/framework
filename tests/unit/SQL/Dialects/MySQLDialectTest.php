<?php
/**
 *  * Created by mtils on 07.01.2023 at 08:58.
 **/
...
class MySQLDialectTest extends TestCase
{
     ...
     * @test
     **/
    public function test_quote_throws_exception_with_unknown_type()
    {
    ...
    public function it_returns_concat_expression()
    {
        ...
        $this->assertEquals('CONCAT', $expression->getRaw());
        $this->assertEquals($args, $expression->getBindings());
    }


    protected function newDialect() : MySQLDialect
    {
        return new MySQLDialect();
    }

    protected function where($key, $op=null, $val=null) : Parentheses
    {
        $g = new Parentheses();
