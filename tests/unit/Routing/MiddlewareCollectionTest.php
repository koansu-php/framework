<?php
/**
 *  * Created by mtils on 26.10.2022 at 18:59.
 **/
...
class MiddlewareCollectionTest extends TestCase
{
    ...
    public function getIterator_returns_right_data()
    {
        ...
        $this->assertEquals($c->__toArray(), $manual);
    }
    ...
    public function invoke_invoke_without_InputHandler_throws_NoInputHandlerException()
    {
        ...
        $this->expectException(NoInputHandlerException::class);
        $c($this->makeInput());
    }
    ...
    protected function make(callable $instanceResolver=null) : MiddlewareCollection
    {
     ...
     */
    protected function makeInput($path='/foo', array $parameters=[], string $clientType=Input::CLIENT_WEB) : MiddlewareCollectionTest_Input
    {
...
class MiddlewareCollectionTest_InputHandler implements InputHandler
{
